...
AUTHOR          = 'Swathi'  # use your name
SITENAME        = 'mypython notes' # use title
GITHUB_USERNAME = 'swathiramu' # use your username
...
# Social widget
SOCIAL = (
    ("GitHub", "https://github.com/swathiramu"),
    ("LinkedIn", "https://www.linkedin.com/in/swathiramu28/"),
)
